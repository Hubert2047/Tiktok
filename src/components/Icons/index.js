...
export function NextIcon({ className, width = '26px', height = '26px' }) {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path
                fillRule='evenodd'
...
export function PrevIcon({ className, width = '26px', height = '26px' }) {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path
                fillRule='evenodd'
...
export function InboxActiveIcon({ className, width = '32px', height = '32px' }) {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path
                fillRule='evenodd'
...
export function TagUserIcon({ className, width = '20px', height = '20px' }) {
    return (
...
export function ArrowIcon({ className, width = '14px', height = '14px' }) {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M25.5187 35.2284C24.7205 36.1596 23.2798 36.1596 22.4816 35.2284L8.83008 19.3016C7.71807 18.0042 8.63988 16 10.3486 16H37.6517C39.3604 16 40.2822 18.0042 39.1702 19.3016L25.5187 35.2284Z'></path>
        </svg>
    )
}
export function CheckBoxIcon({ className, width = '12px', height = '9px' }) {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 10 8' xmlns='http://www.w3.org/2000/svg'>
            <path d='M3.88632 5.95189L8.77465 0.915431C8.96697 0.717276 9.28352 0.712552 9.48168 0.904878L9.67738 1.09483C9.87553 1.28715 9.88026 1.6037 9.68793 1.80185L4.34296 7.3088C4.093 7.56633 3.67963 7.56633 3.42967 7.3088L0.948335 4.75227C0.756009 4.55411 0.760734 4.23757 0.958888 4.04524L1.15459 3.85529C1.35275 3.66297 1.66929 3.66769 1.86162 3.86584L3.88632 5.95189Z'></path>
        </svg>
    )
}

export function WramIcon({ className, width = '16px', height = '16px' }) {
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path d='M24 6C14.0589 6 6 14.0589 6 24C6 33.9411 14.0589 42 24 42C33.9411 42 42 33.9411 42 24C42 14.0589 33.9411 6 24 6ZM2 24C2 11.8497 11.8497 2 24 2C36.1503 2 46 11.8497 46 24C46 36.1503 36.1503 46 24 46C11.8497 46 2 36.1503 2 24ZM27 16C27 17.6569 25.6569 19 24 19C22.3431 19 21 17.6569 21 16C21 14.3431 22.3431 13 24 13C25.6569 13 27 14.3431 27 16ZM23 22C22.4477 22 22 22.4477 22 23V34C22 34.5523 22.4477 35 23 35H25C25.5523 35 26 34.5523 26 34V23C26 22.4477 25.5523 22 25 22H23Z'></path>
        </svg>
    )
}
...
export function StartIcon({ className, width = '20px', height = '20px' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function FaceBookIcon({ className, width = '1em', height = '1em' }) {
    return (
        <svg
            className={className}
            width={width}
    ...
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M24 6C14.0589 6 6 14.0589 6 24C6 33.9411 14.0589 42 24 42C33.9411 42 42 33.9411 42 24C42 14.0589 33.9411 6 24 6ZM2 24C2 11.8497 11.8497 2 24 2C36.1503 2 46 11.8497 46 24C46 36.1503 36.1503 46 24 46C11.8497 46 2 36.1503 2 24Z'></path>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M17 23C18.6569 23 20 21.2091 20 19C20 16.7909 18.6569 15 17 15C15.3431 15 14 16.7909 14 19C14 21.2091 15.3431 23 17 23Z'></path>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M31 23C32.6569 23 34 21.2091 34 19C34 16.7909 32.6569 15 31 15C29.3431 15 28 16.7909 28 19C28 21.2091 29.3431 23 31 23Z'></path>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M16 28.3431C16 31.4673 19.5817 36 24 36C28.4183 36 32 31.4673 32 28.3431C32 25.219 16 25.219 16 28.3431Z'></path>
        </svg>
    )
}
            ...
            <g clipPath='url(#HeartFill_clip0)'>
                <g filter='url(#HeartFill_filter0_d)'>
                    <path
                        fillRule='evenodd'
                        clipRule='evenodd'
                        d='M7.5 2.25C10.5 2.25 12 4.25 12 4.25C12 4.25 13.5 2.25 16.5 2.25C20 2.25 22.5 4.99999 22.5 8.5C22.5 12.5 19.2311 16.0657 16.25 18.75C14.4095 20.4072 13 21.5 12 21.5C11 21.5 9.55051 20.3989 7.75 18.75C4.81949 16.0662 1.5 12.5 1.5 8.5C1.5 4.99999 4 2.25 7.5 2.25Z'></path>
                </g>
                <path
                    fillRule='evenodd'
                    clipRule='evenodd'
...
export function MentionIcon({ className, width = '72px', height = '72px' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function NotificationFollowerIcon({ className, width = '70px', height = '70px' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function NotificationActiveIcon({ className, width = '70px', height = '70px' }) {
    return (
        <svg
            className={className}
            width={width}
            ...
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M34.4961 70.3557C34.7809 70.7422 35.2335 70.971 35.7166 70.971C36.1997 70.971 36.6522 70.7422 36.937 70.3557L45.7854 58.5121H65.6332C67.6978 58.5121 69.376 56.834 69.376 54.7693V4.77091C69.376 2.70629 67.6978 1.02815 65.6332 1.02815H5.79989C3.73527 1.02815 2.05713 2.70629 2.05713 4.77091V54.7693C2.05713 56.834 3.73527 58.5121 5.79989 58.5121H25.6477L34.4961 70.3557ZM5.10829 4.77135C5.10829 4.38996 5.4185 4.07976 5.79989 4.07976H65.6281C66.0095 4.07976 66.3197 4.38996 66.3197 4.77135V54.7749C66.3197 55.1562 66.0095 55.4665 65.6281 55.4665H45.0175C44.5395 55.4665 44.0869 55.6902 43.7971 56.0767L35.7166 66.8981L27.6361 56.0767C27.3513 55.6902 26.8987 55.4614 26.4156 55.4614H5.79989C5.4185 55.4614 5.10829 55.1512 5.10829 54.7698V4.77135Z'></path>
    ...
    return (
        <svg
            ...
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M24 3C17.9249 3 13 7.92487 13 14V21H8C6.89543 21 6 21.8954 6 23V41C6 42.1046 6.89543 43 8 43H40C41.1046 43 42 42.1046 42 41V23C42 21.8954 41.1046 21 40 21H35V14C35 7.92487 30.0751 3 24 3ZM31 21V14C31 10.134 27.866 7 24 7C20.134 7 17 10.134 17 14V21H31Z'></path>
        </svg>
    )
}
...
export function TalkIcon({ className, width = '1em', height = '1em' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function AppleIcon({ className, width = '1em', height = '1em' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function IstalgramIcon({ className, width = '1em', height = '1em' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function GooogleIcon({ className, width = '1em', height = '1em' }) {
    return (
        <svg
            className={className}
            width={width}
...
export function LineIcon({ className, width = '1em', height = '1em' }) {
    return (
        <svg
            className={className}
            width={width}
    ...
    return (
        <svg className={className} width={width} height={height} viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'>
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M19.5 7.50006V9.50006H28.5V7.50006H19.5ZM32.5 9.50006V6.00006C32.5 4.61935 31.3807 3.50006 30 3.50006H18C16.6193 3.50006 15.5 4.61935 15.5 6.00006V9.50006H7C6.44772 9.50006 6 9.94778 6 10.5001V12.5001C6 13.0523 6.44772 13.5001 7 13.5001H9.5V39.5001C9.5 41.7092 11.2909 43.5001 13.5 43.5001H34.5C36.7091 43.5001 38.5 41.7092 38.5 39.5001V13.5001H41C41.5523 13.5001 42 13.0523 42 12.5001V10.5001C42 9.94778 41.5523 9.50006 41 9.50006H32.5ZM34.5 13.5001H13.5V39.5001H34.5V13.5001ZM18.5 34.0001C17.9477 34.0001 17.5 33.5523 17.5 33.0001V20.0001C17.5 19.4478 17.9477 19.0001 18.5 19.0001H20.5C21.0523 19.0001 21.5 19.4478 21.5 20.0001V33.0001C21.5 33.5523 21.0523 34.0001 20.5 34.0001H18.5ZM27.5 34.0001C26.9477 34.0001 26.5 33.5523 26.5 33.0001V20.0001C26.5 19.4478 26.9477 19.0001 27.5 19.0001H29.5C30.0523 19.0001 30.5 19.4478 30.5 20.0001V33.0001C30.5 33.5523 30.0523 34.0001 29.5 34.0001H27.5Z'></path>
        </svg>
    )
}
...
export function ChangeIcon({ className, width = '16px', height = '16px' }) {
    return (
        <svg
            className={className}
            width={width}
